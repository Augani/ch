...
.main-services {
  ...
  `)}
    ...
    .main-services-tile:nth-of-type(3) {
      background: linear-gradient(
        92.63deg,
        rgba(206, 242, 255, 0.5) -0.56%,
        rgba(208, 227, 255, 0) 76.39%
      );
    }
    .main-services-tile:nth-of-type(2) {
      background: linear-gradient(
        -138deg,
        rgba(206, 242, 255, 0.5) 9.61%,
        rgba(208, 227, 255, 0) 45.96%
      );
    }

  .main-services-tile:nth-of-type(5) {
    background: linear-gradient(230.45deg, rgba(151, 204, 252, 0) 55%, #74BBFC 229.42%);  }
  ...
  `)}
    ...
    .main-services-figures-form {
      ...
      background: linear-gradient(
        0deg,
        rgba(151, 228, 252, 0) 0%,
        rgba(146, 246, 252, 0.3048) 30.25%,
        rgba(132, 223, 252, 0.6855) 68.04%,
        #74a2fc 99.26%
      );
    }
